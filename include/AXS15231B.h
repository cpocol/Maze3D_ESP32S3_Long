...
void lcd_PushColors_rotated_90(uint16_t x, uint16_t y, uint16_t width, uint16_t high, uint16_t *data, bool swapBytes);

void lcd_PushColors_mirrored_rotated_90(uint16_t x, uint16_t y, uint16_t width, uint16_t high, uint16_t *data, bool swapBytes);
